  ...
  return (
    <>
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-[var(--color-slate)]">
        ...
        <div className="mt-16 max-w-3xl">
          <h2 className="font-[family-name:var(--font-display)] text-xl text-[var(--color-navy)]">Our story</h2>
          ...
          <div className="grid gap-14 md:grid-cols-[0.8fr_1.2fr]">
            ...
            <div>
              ...
              <p className="mt-6 text-[15px] leading-relaxed text-[var(--color-slate)]">
                ...
                2019 and 2020. He undertook his Articles of Pupillage at the firm of Kounah
                &amp; Company Advocates between 2020 and 2022, and was admitted to the Roll of
                Advocates on 12th May 2022.
              </p>
              <p className="mt-4 text-[15px] leading-relaxed text-[var(--color-slate)]">
                He was subsequently employed at Kounah &amp; Company Advocates as an associate
                advocate from June 2022, gaining considerable experience in conveyancing, civil
                litigation, debt collection, company formation, probate and administration, and
                the preparation and perfection of securities for financial institutions.
              </p>
              <p className="mt-4 text-[15px] leading-relaxed text-[var(--color-slate)]">
              ...
              <a
                href="/team"
                className="mt-4 inline-block text-[15px] text-[var(--color-navy)] underline decoration-[var(--color-gold)] underline-offset-4"
              >
                View the full team
              </a>
            </div>
